...
public class Player extends Block
{
    ...
    public void draw(ShapeRenderer aShape)
    {
        ...
        float xDrawLocation = (xArrayLocation * width + width) + width / 2; //Must divide by 2 to make sure draw location is in middle of block
        float yDrawLocation = (yArrayLocation * height + height) + height / 2;
